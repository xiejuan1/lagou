...
class Position extends Component {
	...
	render() {
		...
		return(
			...
			<span className="info" style={{display:this.state.info?"block":"none"}}>10秒钟定制职位</span>
			<span className="infoes" style={{display:this.state.infoes?"block":"none"}}>Android 成都 5k-10k 成长型</span>
			<h6 className="go">
			<NavLink className="denglu" to="/login" style={{display:this.state.denglu?"block":"none"}}>去登陆</NavLink>
			<NavLink className="bianji" to="/Reduct" style={{display:this.state.bianji?"block":"none"}}>去编辑</NavLink>
			...
			<ul className="list">
					{list}
			<li className="list-mored" onClick={this.handleMore}>加载更多</li>	
			</ul>		
